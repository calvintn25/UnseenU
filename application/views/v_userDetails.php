            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <?= form_open_multipart('index.php/manageUser/viewDetails/' . $userId['id']) ?>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="UserId">Name </label>
                                <input class="form-control" id="UserId" placeholder="<?= $userId['name']; ?>" type="text" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="userGender">Gender </label>
                                <input class="form-control" id="userGender" placeholder="<?= $userId['gender']; ?>" type="text" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="userAddress">Address</label>
                            <input type="text" class="form-control" id="userAddress" placeholder="<?= $userId['address']; ?>" readonly>
                        </div>

                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="PoB">Place of Birth </label>
                                <input class="form-control" id="PoB" placeholder="<?= $userId['PoB']; ?>" type="text" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="DoB">Date of Birth </label>
                                <input class="form-control" id="DoB" type="text" placeholder="<?= $userId['DoB']; ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" id="userEmail" placeholder="<?= $userId['email']; ?>" type="email" readonly>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="PhoneNum">Phone Number</label>
                                <input class="form-control" id="PhoneNum" placeholder="<?= $userId['phone_num']; ?>" type="text" readonly>
                            </div>
                        </div>
                        </form>
