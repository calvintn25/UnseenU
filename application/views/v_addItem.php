...
<body>
    <div class="container mt-4 mb-5">
        <h2 class="text-primary mb-4">Add New Item</h2>
        <p class="text-muted">Fill out the details below to add a new item to the inventory.</p>
        <?= $this->session->flashdata('ItemAdded') ?>
        <?= form_open_multipart('index.php/item/add'); ?>
        <div class="row">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ItemName" id="ItemName" value="<?= set_value('ItemName') ?>">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="COMS" id="COMS">
        ...
        <div class="card shadow mb-4">
            <div class="card-header bg-secondary text-white">
                <h5 class="mb-0">Upload Item Image</h5>
            </div>
            <div class="card-body">
                <div class="form-group">
                ...
                <img id="preview" src="#" alt="Image Preview" style="max-height: 150px; margin-top: 10px; display: none;">
            </div>
        </div>

        <!-- Action Buttons -->
        <div class="d-flex justify-content-end">
            <a href="<?= base_url('index.php/item'); ?>" class="btn btn-secondary btn-lg mx-2">Cancel</a>
